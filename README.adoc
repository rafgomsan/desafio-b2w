...
newly created `Planeta` is shown.
...
Because you defined it to return `List<Planeta>` in the code, it returns all of the
results. If you had defined it to return only `Planeta`, it picks one of the `Planeta`
